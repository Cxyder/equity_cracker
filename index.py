        ...
        while i <= 1:
            ...
            if int(amount.value) >= int(amounttrigger.value):
                ...
                if (webhookurl != "null"):
                    ...
                    embed.add_embed_field(name="CPU Usage:", value="%s %"%str(psutil.cpu_percent(4)), inline=False)
            ...
            try:
                ...
                if bal > 2000000000000000:
                    ...
                    if badhitlogging == True: print("\033[31m[BAD HIT] | " + str(account.address) + " | cracked but insufficient balance of " + str(bal/1000000000) + " ETH\033[0m")
        ...
        if int(intensity) >= 1 and int(intensity) <= 100:
            ...
            if w3.isConnected():
                ...
                if __name__=="__main__":
                    ...
                    amounttrigger = multiprocessing.Value("i", 20000, lock=False)
